...
<template>
  <div class="relative d-flex items-top justify-center min-h-screen bg-gray-100 sm:align-center sm:pt-0">
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.1.2/dist/tailwind.min.css" rel="stylesheet">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <a class="d-flex justify-center pt-8 sm:pt-0" href="https://nuxtjs.org" target="_blank">
      ...
      <div class="d-flex justify-center pt-4 space-x-2">
