<template>
  <div id="durable-goods-transfer-detail-page">
    ...
    <DurableGoodsTransferForm v-else :item="item" :viewMode="!isCreate" :transferPage="true" type="โอนย้าย" cannotApprove backPath="/durable-goods/transfer/" @submit="onSubmit" />
